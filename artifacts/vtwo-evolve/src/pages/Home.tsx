      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex-shrink-0">
          <a href="#" className="text-xl font-bold text-[#f6f7ff]">
            V.Two <span className="text-[#b091ff]">Ascent</span>
          </a>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <FadeIn delay={0.1}>
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-[#f6f7ff] tracking-tight leading-[1.02] mb-8">
                Your legacy platforms are a liability. <span className="bg-gradient-to-r from-[#9b6bf4] to-[#f05aae] bg-clip-text text-transparent">V.Two Ascent</span> turns them into an advantage.
              </h1>
            </FadeIn>
            <FadeIn delay={0.2}>
              <p className="text-xl md:text-2xl text-[#9096bb] mb-12 max-w-3xl mx-auto leading-relaxed">
                V.Two Ascent modernizes business platforms with AI. Faster than a rewrite. Safer than a lift-and-shift. Priced so the risk sits with us, not you.
              </p>
            </FadeIn>
            <FadeIn delay={0.3}>
              ...
              <div className="bg-[#0f1122] rounded-xl shadow-sm border border-white/10 p-8 md:p-12">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#9096bb] italic mt-6">
                    Composite illustration drawn from V.Two Ascent engagements. Named client references and detailed benchmarks available on request under NDA.
                  </p>
                </div>
              </div>
            </FadeIn>
              ...
              {[
                {
                  ...
                  desc: "Application modernization with AI is not a side practice for us. It is the work. V.Two Ascent exists because we have done this on real platforms, refined the method each time, and codified what works.",
                },
                {
              ...
              <Accordion type="single" collapsible className="w-full space-y-4">
                <AccordionItem value="item-1" className="border border-white/10 rounded-lg px-6 data-[state=open]:border-[#9b6bf4]/50 data-[state=open]:shadow-sm transition-all">
                  ...
                  <AccordionContent className="text-base text-[#9096bb] pb-6 leading-relaxed">
                    Language-agnostic. We have applied V.Two Ascent across older Java, .NET, and database-centric platforms moving to modern cloud-native architectures.
                  </AccordionContent>
                </AccordionItem>
